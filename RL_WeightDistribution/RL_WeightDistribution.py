...
for j in range(3):
    df = pd.read_csv("C:\\Users\\Ilyas Agakishiev\\Desktop\\FOR ANALYSE\\4bottom5\\" + str(j+3) + "0goodweights4py.csv")
...
h.plot(x = "bin",y = ["dd3","dd4","dd5"], kind = "bar", color = ["blue", "red", "gray"], legend = False)
pl.xlabel("Week number") 
pl.ylabel("Value (%)")
pl.title("Av. investment (in %) for 5 least invested coins")
#fig.savefig("Bottom5inv.png", bbox_inches = "tight")
#fig.show()