...
df = pd.read_csv('C:\\Users\\Ilyas Agakishiev\\Desktop\\FOR ANALYSE\\Pythonize\\Performance1.csv', sep=";")
...
ax3.plot_date(new_x,df.iloc[:,3],fmt="-", color="gray",tz=None, xdate=True, linewidth=0.8)
ax4.plot_date(df.iloc[:,4], df.iloc[:,5],fmt="y-", tz=None, xdate=True, linewidth=0.8)
ax2.set_yticklabels([])
ax3.set_yticklabels([])
ax4.set_yticklabels([])
